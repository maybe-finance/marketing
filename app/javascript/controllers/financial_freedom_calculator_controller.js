...
export default class extends Controller {
  ...
  calculate(event) {
    ...
    const monthlySavingsGrowthRate = parseFloat(formData.get("monthly_savings_growth_rate"))
    ...
    this.#renderResults({ months: months, secondsLeft: daysLeft * SECONDS_IN_A_DAY })
  }

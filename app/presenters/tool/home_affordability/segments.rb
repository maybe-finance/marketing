class Tool::HomeAffordability::Segments
  ...
  def to_a
    [
      { category: "Affordable", value: breakpoints[0] },
      { category: "Good", value: breakpoints[1] - breakpoints[0] },
      { category: "Caution", value: breakpoints[2] - breakpoints[1] },
      { category: "Risky", value: breakpoints[3] - breakpoints[2] }
    ]
  end
  ...
  private
    ...
    def breakpoints
      @breakpoints ||= BASE_DTI_RATIOS.map do |base_dti_ratio|
        ...
        payment_after_hoa_pmi = max_monthly_housing_payment - hoa_plus_pmi

        estimated_loan_amount = present_value(payment_after_hoa_pmi)
